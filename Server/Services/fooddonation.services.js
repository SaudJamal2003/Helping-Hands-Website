...
module.exports.insertFoodDetails = async(obj, id=0) =>{
    ...
    // const [{affectedRows2}] = await db.query('INSERT INTO FoodDonation(fd_id, pickup_location, donation_date, donation_time, quantity, city, zip_code, foundation_id) VALUES (?, ?, sysdate(), current_time(), ?, ?, ?, ?)',
    // [0, obj.pickup_location, obj.quantity, obj.city, obj.zip_code, foundation_id]);
    // return affectedRows2;
    try {
        const query = `CALL InsertFoodDonation(?, ?, ?, ?, ?, ?)`;
